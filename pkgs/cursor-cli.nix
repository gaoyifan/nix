  ...
  platform =
    {
      x86_64-linux = {
        os = "linux";
        arch = "x64";
        hash = "sha256-Y7F6DsD0tzvz7VQKJNUTkb/gHDfVlh3/rcu/GosCSZw=";
      };
      aarch64-linux = {
        os = "linux";
        arch = "arm64";
        hash = "sha256-jAbwaDTHRyto3wc1NGKInHsoSygKKjoyPqHf0mlyrek=";
      };
      aarch64-darwin = {
        os = "darwin";
        arch = "arm64";
        hash = "sha256-dQHcrtApbJ+ue6VmyP0x4IWS/n7Ew+9oRdAaunLx/hQ=";
      };
    }
    .${
