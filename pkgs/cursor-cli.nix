  ...
  platform =
    {
      x86_64-linux = {
        os = "linux";
        arch = "x64";
        hash = "sha256-b3Cto3PPR8ZwAPmKfnOoRytPz3VNlzxUMQ2/FHqxzEE=";
      };
      aarch64-linux = {
        os = "linux";
        arch = "arm64";
        hash = "sha256-QzFCQ8xpD4O4PXDKs2OMOHwjYErR4gKe0hBp1objNCw=";
      };
      aarch64-darwin = {
        os = "darwin";
        arch = "arm64";
        hash = "sha256-VnghOkndAB8InpluJPPLlc+UGCyH4z+cxt7TLT0C6Kg=";
      };
    }
    .${
