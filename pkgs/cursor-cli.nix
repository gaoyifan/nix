  ...
  platform =
    {
      x86_64-linux = {
        os = "linux";
        arch = "x64";
        hash = "sha256-dZkIQYtFEWMYf52gaHnKgFVb6mlFADgMW4ZOalsSbmQ=";
      };
      aarch64-linux = {
        os = "linux";
        arch = "arm64";
        hash = "sha256-nvdIBhmXjJwTKwhVNnNgqiHr2xd9MNzE+bHXAPg8Fkw=";
      };
      aarch64-darwin = {
        os = "darwin";
        arch = "arm64";
        hash = "sha256-LOnDC+kt8XkhJAg5/uq0LG7CsQ6waAr2mKRTP8FU0R8=";
      };
    }
    .${
