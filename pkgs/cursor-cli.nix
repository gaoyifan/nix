  ...
  platform =
    {
      x86_64-linux = {
        os = "linux";
        arch = "x64";
        hash = "sha256-bMWpSbGR1RodaUv0j4SEWOXsfPWzBmoyK4lwQsprxXg=";
      };
      aarch64-linux = {
        os = "linux";
        arch = "arm64";
        hash = "sha256-1uHMYKrEr/ZzZo87DAicrm2+LHEvyO9HtCjeLq3D0H4=";
      };
      aarch64-darwin = {
        os = "darwin";
        arch = "arm64";
        hash = "sha256-U9H4BKYfxyLS04hsDGRsjOoYe/bmWzoYaxfCoiG3kOg=";
      };
    }
    .${
