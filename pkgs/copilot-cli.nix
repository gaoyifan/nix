  ...
  platform =
    {
      x86_64-linux = {
        os = "linux";
        arch = "x64";
        hash = "sha256-sc2N+qqWMgEfdf8lZOnfxLQygjnex8mHKPSKuP0hrs8=";
      };
      aarch64-linux = {
        os = "linux";
        arch = "arm64";
        hash = "sha256-NllaYzgu6U4FX0URzWm9XzA5/ebrtUkWFNu2yBXYSq4=";
      };
      aarch64-darwin = {
        os = "darwin";
        arch = "arm64";
        hash = "sha256-/ksYBhRfOWIRKnppt81UHg8d959ClME4BMNfxzH7lVU=";
      };
    }
    .${
