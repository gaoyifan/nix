  ...
  platform =
    {
      x86_64-linux = {
        os = "linux";
        arch = "x64";
        hash = "sha256-/m3hvK+YbOgy4jo1/0iz8jRL3O/NDkbB5p4UmKJXE0g=";
      };
      aarch64-linux = {
        os = "linux";
        arch = "arm64";
        hash = "sha256-rtvFTLdQ26ODKab6BtqREpxQV56foFIl+TK6Qa18cmA=";
      };
      aarch64-darwin = {
        os = "darwin";
        arch = "arm64";
        hash = "sha256-5MKlXFVI83jfdB5usZc1t1HvoT+pQR7loyn4EdUul+E=";
      };
    }
    .${
