...
in {
  ...
  config = lib.mkIf cfg.enable {
    users.groups.telegram-bot-api = lib.mkIf telegramBotApi.enable {};
    users.users.telegram-bot-api = lib.mkIf telegramBotApi.enable {
      isSystemUser = true;
    ...
    systemd.services = lib.mkMerge (
      [
        (lib.mkIf telegramBotApi.enable {
          telegram-bot-api = {
    ...
    services.nginx = lib.mkIf telegramBotApi.enable {
      enable = true;
      user = "telegram-bot-api";
      group = "telegram-bot-api";
    ...
    networking.nftables.tables.telegram-bot-api = lib.mkIf telegramBotApi.enable {
      family = "inet";
      content = ''
        chain input {
