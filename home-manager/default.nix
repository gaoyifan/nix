...
in {
  ...
  home.file = lib.mkMerge [
    (lib.mkIf config.services.mutagen.dotfileSync.enable {
      ...
      ".pi/agent/AGENTS.md".source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.syncd-dotfiles/.agents/AGENTS.md";
      ".pi/agent/auth.json".source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.syncd-dotfiles/.pi/agent/auth.json";
